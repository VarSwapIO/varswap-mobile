...
import { ChainId, ChainIdTo } from "constants/chains";
import { AssetType } from "entity/assets";

export type ChainIdToTxIdToDetails = ChainIdTo<{
...
export interface FiatPurchaseTransactionInfo extends BaseTransactionInfo {
  ...
  inputCurrency?: Pick<any, "type" | "code">;
  inputCurrencyAmount?: number;
  // metadata will be used to get the output currency
  outputCurrency?: Required<Pick<any, "type" | "metadata">>;
