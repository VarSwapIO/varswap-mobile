...
import {TraceProps} from 'components/telemetry/Trace';
import {TraceEventProps} from 'components/telemetry/TraceEvent';
// import {ImportType} from 'features/onboarding/utils';
// import {MobileEventName} from 'features/telemetry/constants';
// import {
//   EthMethod,
//   WCEventType,
//   WCRequestOutcome,
// } from 'features/walletConnect/types';
...
//   [MobileEventName.FiatOnRampWidgetOpened]: BaseEventProperty & {
...
export type TelemetryTraceProps = Omit<
  TraceProps,
  'logImpression' | 'startMark' | 'endMark'
>;
