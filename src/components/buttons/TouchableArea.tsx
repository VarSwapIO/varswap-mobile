...
import { withAnimated } from "components/animated";
// import {TraceEvent} from 'components/telemetry/TraceEvent';
// import {ReactNativeEvent} from 'features/telemetry/constants';
import { TelemetryEventProps } from "features/telemetry/types";
import { defaultHitslopInset } from "styles/sizing";
...
export function TouchableArea({
  ...
  return (
    <AnimatedTouchableBox
      style={scaleTo ? animatedStyle : undefined}
      {...baseProps}
    >
      {children}
    </AnimatedTouchableBox>
