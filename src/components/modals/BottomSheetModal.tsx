...
import { HandleBar } from "components/modals/HandleBar";
...
import { TelemetryTraceProps } from "features/telemetry/types";
import { dimensions, spacing } from "styles/sizing";
...
export function BottomSheetModal({
  ...
  const fullScreenContentHeight =
    (renderBehindInset ? 1 : FULL_HEIGHT) * dimensions.fullHeight;
      ...
      <Trace logImpression modal={name} properties={properties}>
        <BottomSheetView
          style={[
            ...
            renderBehindInset
              ? { ...BottomSheetStyle.behindInset, borderRadius }
              : undefined,
          ]}
