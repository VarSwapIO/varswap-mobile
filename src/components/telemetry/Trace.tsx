...
// import {useIsPartOfNavigationTree} from 'app/navigation/hooks';
import {
  ElementName,
  MarkNames,
  ModalName,
...
import { useTrace } from "features/telemetry/hooks";
import { AppScreen, Screens } from "screens/Screens";
...
function _Trace({
  ...
  const isPartOfNavigationTree = true;
...
type NavAwareTraceProps = Pick<
  TraceProps,
  "logImpression" | "properties" | "directFromPage"
>;
...
function NavAwareTrace({
  ...
  combinedProps: ITraceContext;
} & PropsWithChildren<NavAwareTraceProps>): JSX.Element {
